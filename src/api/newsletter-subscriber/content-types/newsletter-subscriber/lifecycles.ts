...
export default {
    async afterCreate(event) {
        ...
        strapi.log.info('Newsletter Subscriber afterCreate triggered for ID:', result.id);
        ...
        `;
                ...
                strapi.log.info(`Email отправлен (Newsletter Subscriber)`);
            } catch (err) {
                strapi.log.error('Ошибка отправки email (Newsletter Subscriber):', err);
            }
        }
    },
};
